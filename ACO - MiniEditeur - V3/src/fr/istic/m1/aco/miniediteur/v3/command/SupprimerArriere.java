 ...
 * Commande qui execute l'action SupprimerArriere du Mini-Editeur
 */
public class SupprimerArriere implements Command {

	private ME me;
	private Enregistreur enregistreur;
	private GestionDefaire gd;
	
	public SupprimerArriere(ME me, Enregistreur enregistreur, GestionDefaire gd) {
		this.me = me;
